...
namespace internPJ3.Web.Startup
{
    ...
    public class internPJ3NavigationProvider : NavigationProvider
    {

    //[AbpAuthorize(PermissionNames.Nav_Tab)]
                        ...
                        new MenuItemDefinition(
                            ...
                            new MenuItemDefinition(
								...
								new MenuItemDefinition(
										...
										permissionDependency: new SimplePermissionDependency(PermissionNames.Pages_Shopee)
										)
								 )
								.AddItem(
								new MenuItemDefinition(
