(function ($) {
    ...
    _$form.find('.save-button').on('click', (e) => {
        ...
        //Chuyển đổi dữ liệu về obj
        var role = _$form.serializeFormToObject();
        //Xóa danh sách quyền trước khi cập nhật lại
        role.grantedPermissions = [];

        //Lấy tất cả những hộp chọn được đánh dấu
        var _$permissionCheckboxes = _$form[0].querySelectorAll("input[name='permission']:checked");

        //Nếu permission checkbox có tồn tại giá trị
        if (_$permissionCheckboxes) {
          for (var permissionIndex = 0; permissionIndex < _$permissionCheckboxes.length; permissionIndex++) {
                //Lấy checkbox tại vị trí đang duyệt và chuyển thành jQuery object
                var _$permissionCheckbox = $(_$permissionCheckboxes[permissionIndex]);
                //Lấy giá trị của checkbox và thêm vào danh sách quyền được cấp
